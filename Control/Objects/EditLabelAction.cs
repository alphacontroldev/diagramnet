...
namespace Dalssoft.DiagramNet.Objects
{
    ...
    /// </summary>
    internal class EditLabelAction : IEditLabelAction
    {
        ...
        public void StartEdit(BaseElement el, TextBox textBox)
        {
            ...
            siteLabelElement = el;
            labelElement = ((ILabelElement)siteLabelElement).Label;
            labelTextBox = textBox;
            if (siteLabelElement is BaseLinkElement)
                direction = LabelEditDirection.Both;
            else
                direction = LabelEditDirection.UpDown;

            SetTextBoxLocation(siteLabelElement, labelTextBox);
